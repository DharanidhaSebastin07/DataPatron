...
function GridBackground() {
  return (
    <div className="absolute inset-0 pointer-events-none">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-blue-500/4 blur-[100px]" />
    </div>
  );
}
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 pb-24">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-display font-bold tracking-tight mb-4 leading-tight" data-testid="text-heading">
            Ingest data into{" "}
            <span className="bg-gradient-to-r from-orange-500 via-amber-400 to-blue-400 bg-clip-text text-transparent">
              Databricks Delta
            </span>
          </h2>
  ...
  return (
    <div className="h-screen flex flex-col bg-background">
      <header className="flex items-center justify-between gap-2 px-5 py-3 border-b border-border/30 shrink-0">
        <div className="flex items-center gap-3">
          <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-orange-500 to-blue-500 flex items-center justify-center">
